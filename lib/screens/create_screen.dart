...
class _CreateScreenState extends State<CreateScreen> {
  ...
  static const _moods = [
    {'key': 'hype', 'label': '🔥 Hype', 'color': BColor.hype},
    {'key': 'chill', 'label': '🌊 Chill', 'color': BColor.chill},
    {'key': 'deep', 'label': '🌙 Deep', 'color': BColor.deep},
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: _isAnon ? BColor.deep.withOpacity(0.08) : BColor.bg1,
                borderRadius: BorderRadius.circular(12),
                border: Border.all(color: _isAnon ? BColor.deep.withOpacity(0.4) : BColor.border, width: _isAnon ? 1.5 : 1),
              ),
              child: Row(children: [
          ...
          GestureDetector(
            ...
            child: Container(
              ...
              padding: const EdgeInsets.all(14),
              decoration: BoxDecoration(
                color: _isTimeCapsule ? BColor.deep.withOpacity(0.08) : BColor.bg1,
                borderRadius: BorderRadius.circular(12),
                border: Border.all(color: _isTimeCapsule ? BColor.deep.withOpacity(0.4) : BColor.border, width: _isTimeCapsule ? 1.5 : 1),
              ),
              child: Row(children: [
                const Text('⏳', style: TextStyle(fontSize: 24)),
                const SizedBox(width: 12),
