...
class _NotifTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      color: n.read ? Colors.transparent : BColor.logoA.withOpacity(0.05),
  ...
  Color _iconColor(String type) {
    switch (type) {
      ...
      case 'comment': return BColor.chill;
      case 'follow': return BColor.green;
      case 'mention': return BColor.logoA;
