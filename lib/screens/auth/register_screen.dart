  ...
  Widget _buildStep3() => Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
    ...
    Wrap(spacing: 8, runSpacing: 8, children: _roles.map((r) => GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: _role == r ? BColor.text.withOpacity(0.1) : Colors.transparent,
...
class _ErrorBox extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(color: BColor.danger.withOpacity(0.1), borderRadius: BorderRadius.circular(10), border: Border.all(color: BColor.danger.withOpacity(0.4))),
    child: Row(children: [
