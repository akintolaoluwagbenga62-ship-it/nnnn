    ...
    return Scaffold(
          ...
          child: Row(children: [
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              Row(children: [
                ...
                if (widget.chat.isAiModerated) ...[const SizedBox(width: 4), const Icon(Icons.smart_toy, color: BColor.chill, size: 13)],
              ]),
      ...
      body: Column(children: [
        ...
        if (currentPinned != null) Container(
          ...
          color: BColor.deep.withOpacity(0.08),
          child: Row(children: [
            const Icon(Icons.push_pin, color: BColor.deep, size: 14),
        ...
        if (_isRecording) Container(
          ...
          color: BColor.danger.withOpacity(0.08),
          child: Row(children: [
          ...
          child: Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: _anon ? BColor.deep.withOpacity(0.2) : Colors.transparent,
                  shape: BoxShape.circle,
                  border: Border.all(color: _anon ? BColor.deep : BColor.border),
                ),
            ...
            Expanded(child: Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: _anon ? BColor.deep.withOpacity(0.5) : BColor.border),
              ),
              child: TextField(
                controller: _ctrl,
                maxLines: null,
        ...
        if (_anon) Container(
          ...
          child: const Text('👻 You are posting anonymously — your identity is hidden', style: TextStyle(fontSize: 11, color: BColor.deep, fontWeight: FontWeight.w600), textAlign: TextAlign.center),
        ),
      ]),
    );
  }
            ...
            Flexible(child: Column(
              ...
              children: [
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: isMe ? BColor.text : (isAnon ? BColor.deep.withOpacity(0.15) : BColor.bg1),
                    ...
                    border: isMe ? null : Border.all(color: isAnon ? BColor.deep.withOpacity(0.3) : BColor.border),
                  ),
    ...
    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      SizedBox(
        ...
        child: ClipRRect(borderRadius: BorderRadius.circular(2), child: LinearProgressIndicator(
          ...
          backgroundColor: (widget.isMe ? BColor.bg : BColor.text).withOpacity(0.2),
          valueColor: AlwaysStoppedAnimation(widget.isMe ? BColor.bg : BColor.text),
        )),
      ),
      const SizedBox(height: 4),
      Text(widget.duration, style: TextStyle(fontSize: 11, color: widget.isMe ? BColor.bg.withOpacity(0.7) : BColor.muted)),
    ]),
  ]);
}
...
class _AiBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(color: BColor.chill.withOpacity(0.08), borderRadius: BorderRadius.circular(12), border: Border.all(color: BColor.chill.withOpacity(0.3))),
      child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
        const Icon(Icons.smart_toy, color: BColor.chill, size: 16),
        const SizedBox(width: 8),
          ...
          ...List.generate(opts.length, (i) {
            ...
            return GestureDetector(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: voted ? BColor.text.withOpacity(0.08) : Colors.transparent,
                ...
                child: Stack(children: [
                  if (_voted != null) Positioned.fill(child: FractionallySizedBox(
                    ...
                    child: Container(decoration: BoxDecoration(color: BColor.text.withOpacity(0.06), borderRadius: BorderRadius.circular(8))),
                  )),
                  Row(children: [
    ...
    ...chat.participants.map((id) {
      ...
      return ListTile(
        ...
        trailing: id == chat.participants.first
            ? Container(padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 3), decoration: BoxDecoration(color: BColor.gold.withOpacity(0.15), borderRadius: BorderRadius.circular(8)), child: const Text('Admin', style: TextStyle(color: BColor.gold, fontSize: 11, fontWeight: FontWeight.w700)))
            : null,
      );
    }),
...
class _GroupInfoSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Column(mainAxisSize: MainAxisSize.min, children: [
    ...
    if (chat.isAiModerated) Container(
      ...
      decoration: BoxDecoration(color: BColor.chill.withOpacity(0.1), borderRadius: BorderRadius.circular(8), border: Border.all(color: BColor.chill.withOpacity(0.3))),
      child: const Text('🤖 AI Moderated — Bondly AI keeps this space safe', style: TextStyle(color: BColor.chill, fontSize: 12)),
    ),
    const SizedBox(height: 20),
