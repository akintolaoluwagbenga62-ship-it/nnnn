            ...
            ScaleTransition(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [BoxShadow(color: BColor.logoA.withOpacity(0.4), blurRadius: 30, spreadRadius: 5)],
                ),
            ...
            child: Column(children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                ...
                GestureDetector(
                  ...
                  child: Container(
                    width: 72, height: 72,
                    decoration: BoxDecoration(color: BColor.danger, shape: BoxShape.circle, boxShadow: [BoxShadow(color: BColor.danger.withOpacity(0.4), blurRadius: 20)]),
