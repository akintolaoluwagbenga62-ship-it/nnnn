      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverToBoxAdapter(child: Column(children: [
            ...
            // Cover
            Container(height: 120, decoration: const BoxDecoration(gradient: LinearGradient(colors: [Color(0xFF1a1a2e), Color(0xFF000000)]))),
                        ...
                        child: displayPosts[i].isAnonymous
                            ...
                            : Stack(fit: StackFit.expand, children: [
                                ...
                                if (displayPosts[i].isTimeCapsule) Positioned(top: 6, right: 6, child: Container(
                                  ...
                                  decoration: BoxDecoration(color: BColor.bg.withOpacity(0.7), shape: BoxShape.circle),
                                  child: const Text('⏳', style: TextStyle(fontSize: 12)),
                                )),
                                Positioned(bottom: 6, left: 6, child: Container(
                                  padding: const EdgeInsets.symmetric(horizontal: 4, vertical: 2),
                                  decoration: BoxDecoration(color: BColor.bg.withOpacity(0.6), borderRadius: BorderRadius.circular(4)),
...
class _IconBtn extends StatelessWidget {
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      width: 36, height: 36,
      decoration: BoxDecoration(color: active ? BColor.text.withOpacity(0.1) : Colors.transparent, shape: BoxShape.circle, border: Border.all(color: active ? BColor.text : BColor.border)),
  ...
  Widget build(BuildContext context) => GestureDetector(
    ...
    child: Container(
      ...
      decoration: BoxDecoration(
        color: ghostMode ? BColor.text.withOpacity(0.1) : Colors.transparent,
